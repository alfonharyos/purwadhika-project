...
# --- DAG Definition ---
with DAG(
    dag_id="dag_dbt_taxi_trip_monthly",
    description="DBT Taxi Trip ETL monthly: preparation -> model -> mart",
    tags=["monthly", "dbt", "taxi_trip", "bigquery"],
    ...
    # Tasks
    dbt_taxi_prep = make_dbt_task("dbt_taxi_prep", "taxi_trip", "preparation", "us_central1")
    dbt_taxi_model = make_dbt_task("dbt_taxi_model", "taxi_trip", "model", "us_central1")
    dbt_taxi_mart = make_dbt_task("dbt_taxi_mart", "taxi_trip", "mart", "us_central1")

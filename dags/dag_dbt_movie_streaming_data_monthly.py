...
with DAG(
    dag_id="dag_dbt_movie_streaming_data_monthly",
    description='DBT Movie Streaming ETL monthly: preparation -> model -> mart',
    tags=['monthly', 'dbt', 'movie_streaming', 'bigquery'],
